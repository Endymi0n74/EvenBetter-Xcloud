...
## Journal (archivé dans docs/)

Le journal daté a été extrait vers des fichiers dédiés (ne pas mettre à jour) :

| Fichier | Contenu |
|---|---|
| [docs/journal-features.md](docs/journal-features.md) | Features, rebrand, routines |
| [docs/journal-perf.md](docs/journal-perf.md) | Mesures, verdicts codec/bitrate, baselines |
| [docs/journal-gates.md](docs/journal-gates.md) | Gates CI |
...
## CI — job `startup-cold` (workflow bench.yml, workflow_dispatch uniquement)
